$(document).ready(function () {
    ...
    //     messages: {
    //         name: {
    //             required: "Полжалуйста, введите свое имя",
    //             minlength: jQuery.validator.format("Введите {0} символа")
    //         },
    //         phone: "Полжалуйста, введите свой телефон",
    //         email: {
    //             required: "Полжалуйста, введите свой email",
    //             email: "Твой email должен быть в формате name@domain.com"
    //         }
    //     }
    // });
    // $('#order form').validate();
